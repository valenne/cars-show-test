...
import {footerLinks} from '../../constants/pageData';
...
function Footer() {
  return (
    <footer className='flex flex-col text-black-100 mt-5 border-t border-gray-100'>
      ...
      <div className='flex-1 flex justify-between items-center flex-wrap mt-10 border-t border-gray-100 sm:px-16 px-6 py-10'>
